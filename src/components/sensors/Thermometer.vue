<template>
  ...
  <div v-else class="therm-container">
    ...
    <div>
      <span class="therm-value" style="left: 60%; top: 10%"
        >max: <span style="color: #ffb4b4">0</span>{{ degree }}</span
      >
      <span class="therm-value" style="left: 15%; top: 20%"
        >{{ dataNow }}{{ degree }}</span
      >
      <span class="therm-value" style="left: 60%; bottom: 10%"
        >min: <span style="color: #7ed9f3">0</span>{{ degree }}</span
      >
    </div>
  </div>
</template>
