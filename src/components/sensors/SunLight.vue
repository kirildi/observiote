...
export default {
  ...
  setup(props) {
    ...
    function drawValue(value, posX, posY, styleColor) {
      ctx.font = "12px Arial"
      ctx.fillStyle = "rgba(255,255,255,1)"
    ...
    function drawBody() {
      ...
      drawValue(
        `${props.data.max}${props.data.scale}`,
        90,
        50,
        "rgba(27,27,27,1.0)"
      )
      drawValue(
        `${props.data.now}${props.data.scale}`,
        90,
        120,
        "rgba(27,27,27,1.0)"
      )
      drawValue(
        `${props.data.min}${props.data.scale}`,
        90,
        194,
        "rgba(27,27,27,1.0)"
      )
